...
const MobileNavLink = ({ title, icon, to, isButton, onClick }) => {
    ...
    return (
        <Link
            ...
            onClick={onClick}
            className={`
                flex items-center space-x-2 px-4 py-2 rounded-md transition-colors w-full relative
                ${isButton
                ? 'bg-blue-600 hover:bg-blue-700 text-white'
                : isActive
...
const DropdownItem = ({ title, description, to, onClick }) => {
    ...
    return (
        <Link
            ...
            `}
        >
            <div className={`font-medium ${isActive ? 'text-blue-600' : ''}`}>{title}</div>
            <div className={`text-sm ${isActive ? 'text-blue-500' : 'text-gray-500 dark:text-gray-400'}`}>{description}</div>
        </Link>
    );
};
                ...
                <div className="flex justify-between items-center py-3">
                    ...
                    <nav className="hidden md:flex items-center space-x-6">
                        ...
                        <div className="relative" ref={modulesRef}>
                            <button
                                className={`
                                    flex items-center space-x-1 px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors relative
                ...
                <div className={`md:hidden py-4 px-4 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                    <nav className="flex flex-col space-y-4">
                        ...
                        <div>
                            <button
                                className={`
                                    w-full flex items-center justify-between px-4 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors
