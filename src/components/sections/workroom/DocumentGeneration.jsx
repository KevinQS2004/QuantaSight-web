                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                        <div className="md:w-1/2">
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-200/30">
                                <div className="grid grid-cols-3 gap-4 text-center">
                                    <div>
                                        <div className="text-lg font-bold text-blue-600 drop-shadow-sm">50+</div>
                                        <div className="text-xs text-gray-500">Templates</div>
                                    </div>
                                    <div>
                                        <div className="text-lg font-bold text-green-600 drop-shadow-sm">10+</div>
                                        <div className="text-xs text-gray-500">Formats</div>
                                    </div>
                                    <div>
                                        <div className="text-lg font-bold text-purple-600 drop-shadow-sm">95%</div>
                        ...
                        <div className="md:w-1/2">
                            <div className="relative">
                                ...
                                {/* Floating badges */}
                                <div className={`absolute -top-3 -right-3 glass-light rounded-lg px-3 py-2 text-xs font-medium text-blue-700 shadow-lg ${
                                    darkMode ? 'shadow-gray-800/30' : 'shadow-blue-200/50'
                                }`}>
                                    AI-Powered
                                </div>

                                <div className={`absolute -bottom-3 -left-3 glass-light rounded-lg px-3 py-2 text-xs font-medium text-green-700 shadow-lg ${
                                ...
                                <div className="absolute -z-10 top-6 right-6 w-20 h-20 bg-blue-400/20 rounded-full blur-2xl"></div>
                                <div className="absolute -z-10 bottom-6 left-6 w-16 h-16 bg-purple-400/20 rounded-full blur-xl"></div>
                            </div>
                        </div>
                    </div>
                </div>
