...
const FeatureCard = ({ title, description, icon, badge }) => {
    return (
        <div className={`professional-card p-8 h-full flex flex-col transition-all duration-300 hover:-translate-y-1 shadow-xl hover:shadow-2xl glass-card`} style={{
            ...
            <div className="flex flex-col items-center text-center">
                <div className="relative mb-6">
                    <div className="p-4 rounded-xl bg-blue-50 shadow-lg transition-all duration-300 hover:scale-110">
        ...
        <section className={`py-20 ${darkMode ? 'bg-gray-900' : 'bg-gradient-to-b from-gray-50/50 to-white'}`}>
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                    <div className={`p-6 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl ${
                ...
                {/* Trust indicators */}
                <div className={`p-8 rounded-xl text-center transition-all duration-300 shadow-lg hover:shadow-xl ${
                    darkMode
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div>
                            <div className="text-2xl font-bold text-blue-600 mb-1 drop-shadow-sm">99.9%</div>
                            <div className="text-xs text-gray-500">Uptime</div>
                        </div>
                        <div>
                            <div className="text-2xl font-bold text-green-600 mb-1 drop-shadow-sm">500+</div>
                            <div className="text-xs text-gray-500">Active Users</div>
                        </div>
                        <div>
                            <div className="text-2xl font-bold text-purple-600 mb-1 drop-shadow-sm">50+</div>
