                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    <div className="lg:w-1/2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                            <div className={`p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                                ...
                                <Zap className="w-6 h-6 text-blue-600 mb-3 drop-shadow-sm" />
                            ...
                            <div className={`p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                                ...
                                <Shield className="w-6 h-6 text-green-600 mb-3 drop-shadow-sm" />
                            ...
                            <div className={`p-5 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ${
                                ...
                                <FileText className="w-6 h-6 text-purple-600 mb-3 drop-shadow-sm" />
                    ...
                    <div className="lg:w-1/2 flex justify-center">
                        <div className="relative">
                            ...
                            <div className={`professional-card p-8 max-w-md transform hover:scale-105 transition-all duration-500 shadow-xl hover:shadow-2xl ${
                                darkMode
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className={`p-4 rounded-lg text-xs shadow-inner ${darkMode ? 'bg-gray-700' : 'bg-gray-100'}`}>
                                    ...
                                    <div className={`p-4 rounded-lg shadow-lg ${darkMode ? 'bg-blue-900/20' : 'bg-blue-50'}`}>
                            ...
                            <div className={`absolute -top-4 -right-4 glass-light rounded-lg px-3 py-2 text-xs font-medium text-green-700 shadow-xl ${
                                darkMode ? 'shadow-gray-800/30' : 'shadow-green-200/50'
                            }`}>
                                94% Accuracy
                            </div>

                            <div className={`absolute -bottom-4 -left-4 glass-light rounded-lg px-3 py-2 text-xs font-medium text-blue-700 shadow-xl ${
