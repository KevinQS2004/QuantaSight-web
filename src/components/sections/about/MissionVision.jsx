                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-1">
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200/30">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="text-center">
                                    <div className="text-lg font-bold text-blue-600 drop-shadow-sm">Weeks → Minutes</div>
                                    <div className="text-xs text-gray-500">Time Reduction</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-lg font-bold text-green-600 drop-shadow-sm">AI-Driven</div>
                    ...
                    <div className={`professional-card p-8 h-full flex flex-col transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 ${
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200/30">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="text-center">
                                    <div className="text-lg font-bold text-purple-600 drop-shadow-sm">AI + Human</div>
                                    <div className="text-xs text-gray-500">Collaboration</div>
                                </div>
                                <div className="text-center">
                                    <div className="text-lg font-bold text-indigo-600 drop-shadow-sm">Healthcare</div>
