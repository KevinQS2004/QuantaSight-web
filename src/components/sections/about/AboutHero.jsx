                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h1 className={`text-3xl md:text-4xl font-bold mb-6 ${
                            ...
                            <span className="block text-2xl md:text-3xl mt-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">
                                Through Advanced AI
                            </span>
                        </h1>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                        <div className={`text-center p-6 rounded-lg transition-all hover:scale-105 shadow-lg hover:shadow-xl ${
                            darkMode
                                ? 'glass-dark shadow-gray-900/20 hover:shadow-gray-900/30'
                                : 'glass-light shadow-blue-100/40 hover:shadow-blue-200/50'
                        }`}>
                            <div className="text-2xl font-bold text-blue-600 mb-2 drop-shadow-sm">500+</div>
                        ...
                        <div className={`text-center p-6 rounded-lg transition-all hover:scale-105 shadow-lg hover:shadow-xl ${
                            ...
                            <div className="text-2xl font-bold text-blue-600 mb-2 drop-shadow-sm">15+</div>
                        ...
                        <div className={`text-center p-6 rounded-lg transition-all hover:scale-105 shadow-lg hover:shadow-xl ${
                            ...
                            <div className="text-2xl font-bold text-blue-600 mb-2 drop-shadow-sm">98%</div>
                        ...
                        <div className={`text-center p-6 rounded-lg transition-all hover:scale-105 shadow-lg hover:shadow-xl ${
                            ...
                            <div className="text-2xl font-bold text-blue-600 mb-2 drop-shadow-sm">70%</div>
                            <div className="text-xs text-gray-500">Time Reduction</div>
                        </div>
                    </div>

                    {/* Enhanced Mission statement with shadows */}
                    <div className={`professional-card text-center p-8 transition-all duration-300 shadow-xl hover:shadow-2xl ${
                        darkMode
