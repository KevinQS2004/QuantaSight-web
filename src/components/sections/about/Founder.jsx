                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                        <div className="md:w-1/3 flex justify-center">
                            <div className="relative group">
                                <div className={`rounded-full overflow-hidden w-64 h-64 mx-auto border-4 transition-all duration-300 shadow-xl group-hover:shadow-2xl ${
                                    darkMode
                                ...
                                {/* Floating badge */}
                                <div className={`absolute -bottom-4 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-full text-xs font-medium shadow-lg transition-all duration-300 ${
                                    darkMode
