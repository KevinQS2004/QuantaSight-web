...
const ModuleCard = ({ title, description, icon, to, badge }) => {
    ...
    return (
        <Link
            to={to}
            className={`group block professional-card h-full min-h-[320px] transition-all duration-300 hover:scale-105 ${
                darkMode
    ...
    return (
        <section className={`py-16 ${darkMode ? 'bg-gray-800' : 'bg-gradient-to-b from-white to-blue-50/30'}`}>
            <div className="max-w-7l mx-auto px-40">
                ...
                {/* Integration note */}
                <div className={`mt-12 p-6 rounded-xl text-center transition-all duration-300 ${
                    darkMode
