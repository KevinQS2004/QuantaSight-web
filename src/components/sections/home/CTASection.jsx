                    ...
                    <div className="relative p-8 md:p-10">
                        <div className="flex flex-col lg:flex-row items-center gap-8">
                            <div className="lg:w-2/3 text-center lg:text-left">
                                ...
                                <p className="text-base text-gray-600 dark:text-gray-400 mb-6 max-w-lg">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <Link
                                        to="/about"
                                        className={`inline-flex items-center justify-center px-6 py-3 text-sm font-medium rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl ${
                                            darkMode
                                    ...
                                    <div className={`p-8 rounded-2xl transition-all duration-300 ${
                                        ...
                                        <div className="w-32 h-32 mx-auto relative">
                                            ...
                                            <div className="absolute inset-4 rounded-full bg-gradient-to-r from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/30">
                                                <Calendar className="w-12 h-12 text-white drop-shadow-sm" />
                                            </div>
                                        </div>
                                    </div>
