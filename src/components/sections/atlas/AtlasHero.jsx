                ...
                <div className="flex flex-col lg:flex-row items-center gap-12 md:gap-16">
                    <div className="lg:w-1/2 mb-12 md:mb-0">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button className={`px-6 py-3 text-sm font-medium rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl ${
                                darkMode
                    ...
                    <div className="lg:w-1/2 flex justify-center">
                        <div className="relative">
                            ...
                            <div className={`professional-card p-8 max-w-md transform hover:scale-105 transition-all duration-500 shadow-xl ${
                                darkMode
                            ...
                            {/* Floating stats */}
                            <div className={`absolute -top-4 -right-4 glass-light rounded-lg px-3 py-2 text-xs font-medium shadow-lg ${
                                darkMode ? 'text-green-400 shadow-gray-800/30' : 'text-green-700 shadow-green-200/50'
                            }`}>
                                99.2% Uptime
                            </div>

                            <div className={`absolute -bottom-4 -left-4 glass-light rounded-lg px-3 py-2 text-xs font-medium shadow-lg ${
                            ...
                            {/* Background elements */}
                            <div className="absolute -z-10 top-10 right-10 w-32 h-32 bg-blue-400/20 rounded-full blur-3xl animate-pulse"></div>
                            <div className="absolute -z-10 bottom-10 left-10 w-24 h-24 bg-purple-400/20 rounded-full blur-2xl animate-pulse delay-1000"></div>
                        </div>
                    </div>
                </div>
            </div>
