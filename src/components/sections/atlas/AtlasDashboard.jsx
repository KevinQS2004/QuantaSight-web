            ...
            <div className="max-w-7l mx-auto px-40">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`professional-card p-6 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 ${
                            darkMode
                ...
                <div className={`professional-card p-8 text-center transition-all duration-300 shadow-lg hover:shadow-xl ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div>
                            <div className="text-2xl font-bold text-blue-600 mb-1 drop-shadow-sm">350ms</div>
                            <div className="text-xs text-gray-500">Average Load Time</div>
                        </div>
                        <div>
                            <div className="text-2xl font-bold text-green-600 mb-1 drop-shadow-sm">99.9%</div>
                        ...
                        <div>
                            <div className="text-2xl font-bold text-indigo-600 mb-1 drop-shadow-sm">Custom</div>
