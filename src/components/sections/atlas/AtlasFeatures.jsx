                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        ...
                        <div className="flex flex-col items-center">
                            <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 ${
                                ...
                                <MessageSquare className={`w-6 h-6 ${darkMode ? 'text-green-400' : 'text-green-600'}`} />
                            </div>
                        ...
                        <div className="flex flex-col items-center">
                            <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 ${
                                ...
                                <Database className={`w-6 h-6 ${darkMode ? 'text-amber-400' : 'text-amber-600'}`} />
                            </div>
                ...
                <div className="mt-12 pt-8 border-t border-gray-200/50">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <div className="text-center">
                            <div className="text-2xl font-bold text-blue-600 mb-1 drop-shadow-sm">99.2%</div>
                            <div className="text-xs text-gray-500">Detection Accuracy</div>
                        </div>
                        <div className="text-center">
                            <div className="text-2xl font-bold text-green-600 mb-1 drop-shadow-sm">&lt;24h</div>
                            <div className="text-xs text-gray-500">Average Response Time</div>
                        </div>
                        <div className="text-center">
                            <div className="text-2xl font-bold text-purple-600 mb-1 drop-shadow-sm">2.8M</div>
